	...
	public static void main(String[] args) throws IOException {
		...
		while (true)
		{
			...
			case 5:
			{
				...
				MyFrame frame=new MyFrame();frame.MyFrame1(); frame.show();
				MyFrame frame2=new MyFrame();frame2.MyFrame2(); frame2.show();
				MyFrame frame3=new MyFrame();frame3.MyFrame3(); frame3.show();
				MyFrame frame4=new MyFrame();frame4.MyFrame4(); frame4.show();
				while (System.in.available() == 0) { } frame.show(false);frame2.show(false);
				frame3.show(false);frame4.show(false);
				break;
			}
			case 6:
			{
